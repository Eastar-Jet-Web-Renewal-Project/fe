 ...
 *
 * @param {TypographyType} type - 타이포그래피 타입을 지정합니다.
 * @param {TypographySize} [size] - 선택적으로 타이포그래피 크기를 지정합니다.
 * @param {TypographyWeight} [weight] - 선택적으로 타이포그래피 굵기를 지정합니다.
 ...
 *
 * @param {TypographyType} type - 타이포그래피 타입을 지정합니다.
 * @param {TypographySize} [size] - 선택적으로 타이포그래피 크기를 지정합니다. 단, 지정하지 않거나 존재하지 않는 크기를 지정할 경우 기본 크기를 반환합니다.
 ...
 */
export const getFontWeight = (weight?: TypographyWeight): number =>
